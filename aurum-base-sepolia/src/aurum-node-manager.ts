...
export function handleNodeLocationUpdated(event: NodeLocationUpdatedEvent): void {
...
export function handleNodeOwnershipTransferred(event: NodeOwnershipTransferredEvent): void {
...
export function handleSupportedAssetAdded(event: SupportedAssetAddedEvent): void {
  ...
  let assetId = event.params.node.toHexString() + "-" + 
  ...
  updateAssetCapacity(event.params.asset.token, event.params.asset.tokenId, event.block.timestamp)
}

export function handleSupportedAssetsUpdated(event: SupportedAssetsUpdatedEvent): void {
...
export function handleNodeCapacityUpdated(event: NodeCapacityUpdatedEvent): void {
...
function updateAssetCapacity(token: Address, tokenId: BigInt, timestamp: BigInt): void {
