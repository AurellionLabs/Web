...
// NEW  
import { Node, NodeRepository, NodeAsset, NodeAssetConverters } from '@/domain/node/node';
```
...
// Test NodeRepository  
const repo = new BlockchainNodeRepository(contract, provider, signer, auraAsset, pinata);
