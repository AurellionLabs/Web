...
import { getBalance, getOperation, OperationData, requestTokenAllowance, stake } from '@/dapp-connectors/staking-controller';
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <div className="text-green-500">{Number(operation?.reward)}%</div>
                                </div>
                                    ...
                                    <div className="flex items-center gap-2 text-gray-400">
                                        ...
                                        <TooltipProvider>
                                            <Tooltip>
                                                ...
                                                <TooltipContent>
                                                    <p>You are trusting the pool provider to pay out reward</p>
                                                </TooltipContent>
                                            </Tooltip>
                                        </TooltipProvider>
                                    </div>
