...
export class MintedAsset extends Entity {
  ...
  get asset_name(): string {
    let value = this.get("asset_name");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
  ...
  set asset_name(value: string) {
    this.set("asset_name", Value.fromString(value));
  }

  get asset_class(): string {
    let value = this.get("asset_class");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toString();
  ...
  set asset_class(value: string) {
    this.set("asset_class", Value.fromString(value));
  }

  get asset_attributes(): Array<Bytes> {
    let value = this.get("asset_attributes");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
  ...
  set asset_attributes(value: Array<Bytes>) {
    this.set("asset_attributes", Value.fromBytesArray(value));
  }
