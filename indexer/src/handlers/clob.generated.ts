...
// Generated at: 2026-01-13T14:14:28.788Z
//
 ...
 */
ponder.on(
  'Diamond:CLOBOrderCancelled(bytes32,address,uint256,uint8)',
  async ({ event, context }) => {
 ...
 */
ponder.on(
  'Diamond:OrderCreated(bytes32,bytes32,address,uint256,uint256,bool,uint8,uint8,uint256,uint256)',
  async ({ event, context }) => {
    const {
      orderId,
      marketId,
 ...
 */
ponder.on(
  'Diamond:OrderFilled(bytes32,bytes32,uint256,uint256,uint256,uint256)',
  async ({ event, context }) => {
    const {
      orderId,
      tradeId,
 ...
 */
ponder.on(
  'Diamond:OrderPlacedWithTokens(bytes32,address,address,uint256,address,uint256,uint256,bool,uint8)',
  async ({ event, context }) => {
    const {
      orderId,
      maker,
 ...
 */
ponder.on(
  'Diamond:TradeExecuted(bytes32,bytes32,bytes32,address,address,bytes32,uint256,uint256,uint256,uint256,uint256,uint256,bool)',
  async ({ event, context }) => {
    const {
      tradeId,
      takerOrderId,
 ...
 */
ponder.on(
  'Diamond:TradeExecuted(bytes32,bytes32,bytes32,uint256,uint256,uint256)',
  async ({ event, context }) => {
