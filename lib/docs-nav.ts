...
export const NAV_STRUCTURE: NavItem[] = [
    ...
    children: [
      { title: 'Overview', slug: ['smart-contracts', 'overview'] },
      {
        ...
        children: [
          ...
          { title: 'CLOBFacet',            slug: ['smart-contracts', 'facets', 'clobfacet'] },
          { title: 'CLOBFacetV2',          slug: ['smart-contracts', 'facets', 'clobfacetv2'] },
          ...
          { title: 'DiamondCutFacet',      slug: ['smart-contracts', 'facets', 'diamondcutfacet'] },
          { title: 'DiamondLoupeFacet',    slug: ['smart-contracts', 'facets', 'diamondloupefacet'] },
          { title: 'ERC1155ReceiverFacet', slug: ['smart-contracts', 'facets', 'erc1155receiverfacet'] },
          { title: 'NodesFacet',           slug: ['smart-contracts', 'facets', 'nodesfacet'] },
          { title: 'OperatorFacet',        slug: ['smart-contracts', 'facets', 'operatorfacet'] },
          { title: 'OrderEventFacet',      slug: ['smart-contracts', 'facets', 'ordereventfacet'] },
          { title: 'OrderMatchingFacet',   slug: ['smart-contracts', 'facets', 'ordermatchingfacet'] },
          { title: 'OrderRouterFacet',     slug: ['smart-contracts', 'facets', 'orderrouterfacet'] },
          { title: 'OrdersFacet',          slug: ['smart-contracts', 'facets', 'ordersfacet'] },
          { title: 'OwnershipFacet',       slug: ['smart-contracts', 'facets', 'ownershipfacet'] },
      ...
      },
      {
        ...
        children: [
          ...
          { title: 'LibDiamond',       slug: ['smart-contracts', 'libraries', 'libdiamond'] },
          { title: 'OrderUtilsLib',    slug: ['smart-contracts', 'libraries', 'orderutilslib'] },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Hooks Reference',       slug: ['frontend', 'hooks-reference'] },
    ],
  },
  {
    title: 'Indexer',
