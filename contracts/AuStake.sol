...
contract AuStake is ReentrancyGuard, Ownable {
     ...
     * @param reward Percentage reward (100 = 100% return on stake)
     */
    function createOperation(
        ...
        require(reward > 0, 'Reward percentage must be greater than 0');
        ...
        operation.reward = reward;  // Stored as percentage
